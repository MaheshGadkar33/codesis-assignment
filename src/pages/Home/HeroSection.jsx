    ...
    return (
        <section className="w-full relative overflow-hidden bg-white">
            ...
            <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-start min-h-[450px] sm:min-h-[600px] lg:min-h-[900px] pt-[42px] sm:pt-[62px] lg:pt-[84px]">
                    ...
                    <div className="w-full lg:w-[44%] flex flex-col gap-[55px] sm:gap-[82px] lg:gap-[110px] order-2 lg:order-1">
                        ...
                        <div className="flex flex-col gap-[20px] sm:gap-[30px] lg:gap-[40px]">
                            ...
                            {/* Welcome Text */}
                            <p
                                className="text-accent-background font-semibold leading-[20px] ml-4 sm:ml-6 lg:ml-8"
                                style={{
                                    fontSize: '16px',
                                    fontFamily: 'Lexend'
                                }}
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                >
                                    <span className="text-text-primary">Unprecedented Era of </span>
                                    <span className="text-accent-background">Real Estate Investing</span>
                                </h1>
                        ...
                        <div className="relative w-full max-w-[732px] h-[450px] sm:h-[600px] lg:h-[900px] overflow-x-auto lg:overflow-x-visible">
                            ...
                            <div className="absolute top-[80px] sm:top-[120px] lg:top-[-20px] left-[15px] sm:left-[30px] lg:left-[60px] w-[280px] sm:w-[320px] lg:w-[360px] bg-white rounded-[50px] p-[11px] sm:p-[16px] lg:p-[22px] shadow-[13px_13px_0px_rgba(47,49,48,0.3)] border border-gray-200">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-text-primary font-bold text-base leading-[20px]" style={{ fontFamily: 'Roboto' }}>
                                        Investments
                                    </h3>
                                    <img src="/images/img_line_graph.svg" alt="" className="w-[34px] h-[4px]" />
                                </div>
                                ...
                                <div className="bg-white rounded-[24px] p-[14px] shadow-[10px_10px_50px_rgba(0,0,0,0.15)] mb-4">
                                    <div className="flex gap-[14px] items-start mb-2">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h4 className="text-text-primary font-bold text-base leading-[20px] mb-1" style={{ fontFamily: 'Roboto' }}>
                                                Geminin Apartment
                                            </h4>
                                            <p className="text-text-primary text-xs leading-[14px] mb-2 opacity-75" style={{ fontFamily: 'Roboto' }}>
                                                164 S.carson court newport news,VA 23601
                                            </p>
                                            <div className="flex justify-end mb-2">
                                                <span className="text-text-primary text-sm leading-[17px]" style={{ fontFamily: 'Roboto', fontWeight: '700' }}>
                                    ...
                                    {/* Stats Row */}
                                    <div className="flex justify-between items-center text-xs opacity-75 mb-1" style={{ fontFamily: 'Roboto' }}>
                                        <span>Committed</span>
                                        <span>Distribution</span>
                                        <span>Contribution</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm font-medium" style={{ fontFamily: 'Roboto' }}>
                                        <span>$105,555</span>
                                        <span>$473,685</span>
                                        <span>$948,355</span>
                                    </div>
                                    ...
                                    <div className="bg-white rounded-[16px] p-4 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                                        <div className="flex gap-3 items-start">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-text-primary text-xs leading-[15px] mb-2" style={{ fontFamily: 'Roboto', color: '#b0b0b0' }}>
                                                    164 S.carson court<br />
                                                    newport news,VA 23601
                                                </p>
                                                <div className="flex items-center gap-1 mb-2">
                                                    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="#00b894" strokeWidth="3">
                                                        <path d="M6 9l6 6 12-12" />
                                                    </svg>
                                                    <span className="text-text-primary text-xs font-semibold" style={{ fontFamily: 'Roboto', color: '#00b894' }}>
                                                        + 3,5% <span className="font-normal text-gray-500">Yield</span>
                                                    </span>
                                                </div>
                                                ...
                                                {/* Stats */}
                                                <div className="flex justify-between text-xs mb-0.5" style={{ fontFamily: 'Roboto', color: '#b0b0b0' }}>
                                                ...
                                                <div className="flex justify-between text-xs font-bold" style={{ fontFamily: 'Roboto', color: '#2f3130' }}>
                                                    <span>$219,278</span>
                                                    <span>$710,568</span>
                                                    <span>$928,541</span>
                                                </div>
                            ...
                            <div className="absolute top-[80px] sm:top-[120px] lg:top-[-20px] right-[15px] sm:right-[30px] lg:left-[486px] w-[280px] sm:w-[300px] lg:w-[340px] bg-white rounded-[24px] shadow-md overflow-hidden">
                                ...
                                <div className="pt-14 px-4 pb-4">
                                    {/* Name and Title */}
                                    <h3 className="text-text-primary font-bold text-lg mb-1" style={{ fontFamily: 'Roboto' }}>
                                        Julie Craig
                                    </h3>
                                    <p className="text-gray-500 text-sm mb-4" style={{ fontFamily: 'Roboto' }}>
                                        Investor
                                    </p>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mb-4">
                                        ...
                                        <div className="bg-purple-100 rounded-lg p-3 flex items-center gap-2">
                                            ...
                                            <div>
                                                <div className="text-lg font-bold text-text-primary" style={{ fontFamily: 'Roboto' }}>68</div>
                                                <div className="text-xs text-gray-600" style={{ fontFamily: 'Roboto' }}>Deals</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-green-100 rounded-lg p-3 flex items-center gap-2">
                                            ...
                                            <div>
                                                <div className="text-lg font-bold text-green-600" style={{ fontFamily: 'Roboto' }}>80%</div>
                                                <div className="text-xs text-gray-600" style={{ fontFamily: 'Roboto' }}>Match</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 mb-4 pb-4 border-b border-gray-200">
                                        ...
                                        <div className="flex justify-between">
                                            <div>
                                                <div className="text-xs text-gray-500 mb-1" style={{ fontFamily: 'Roboto' }}>Borrowed</div>
                                                <div className="text-lg font-bold text-text-primary" style={{ fontFamily: 'Roboto' }}>$ 350,000</div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-xs text-gray-500 mb-1" style={{ fontFamily: 'Roboto' }}>Paid</div>
                                                <div className="flex items-center gap-1">
                                                    <div className="text-lg font-bold text-text-primary" style={{ fontFamily: 'Roboto' }}>$ 184,000</div>
                                                    <span className="text-xs font-bold text-green-600">62%</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-between">
                                            <div>
                                                <div className="text-xs text-gray-500 mb-1" style={{ fontFamily: 'Roboto' }}>Earned</div>
                                                <div className="flex items-center gap-1">
                                                    <div className="text-lg font-bold text-text-primary" style={{ fontFamily: 'Roboto' }}>$ 166,000</div>
                                                    <span className="text-xs font-bold text-green-600">38%</span>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <div className="text-xs text-gray-500 mb-1" style={{ fontFamily: 'Roboto' }}>Loan Term</div>
                                                <div className="text-lg font-bold text-text-primary" style={{ fontFamily: 'Roboto' }}>12 Months</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Collaborators */}
                                    <div className="mb-4">
                                        <div className="text-xs text-gray-500 mb-2" style={{ fontFamily: 'Roboto' }}>19 Collaborators</div>
                                        <div className="flex items-center">
                                            <div className="flex -space-x-3">
                                                <img src="/images/img_ellipse_49.png" alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                                                <img src="/images/img_ellipse_50.png" alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                                                <img src="/images/img_ellipse_49.png" alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                                                <img src="/images/img_ellipse_50.png" alt="" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                                                <div className="w-8 h-8 rounded-full border-2 border-primary-light bg-purple-100 flex items-center justify-center">
                                                    <span className="text-xs font-bold text-primary-light">+14</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Navigation Bar */}
                                    <div className="flex justify-around items-center pt-3 border-t border-gray-200 bg-gray-50 -mx-4 -mb-4 px-4 py-3 rounded-b-[24px]">
